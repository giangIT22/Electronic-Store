	    	...
	    	<div class="col-md-12 stretch-card">
				    ...
				    <div class="card-body">
				    	<div class="form-group row">
						    <label class="col-sm-2 col-form-label" style="padding-top:0;">Mã đơn hàng</label>
						...
						<div class="form-group row">
						    <label class="col-sm-2 col-form-label" style="padding-top:0;">Tên khách hàng</label>
						    <div class="col-sm-10"><?= $order['customer_name'] ?? null ?></div>
						</div>

						<div class="form-group row">
						    <label class="col-sm-2 col-form-label" style="padding-top:0;">Email khách hàng</label>
						    <div class="col-sm-10"><?= $order['customer_email'] ?? null ?></div>
						</div>

						<div class="form-group row">
						    <label class="col-sm-2 col-form-label" style="padding-top:0;">Số điện thoại</label>
